...
<div class="container-fluid h-100">
    ...
    <div class="d-flex p-4 mt-3">
        <h3 class="pe-5"><a href="{{ route('dashboard.orders') }}" class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
            Vedi riepilogo ordini
        </a></h3>
        <h3><a href="{{ route('dashboard.chart') }}" class="link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
